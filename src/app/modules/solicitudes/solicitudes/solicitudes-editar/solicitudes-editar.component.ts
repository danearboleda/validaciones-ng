...
@Component({
  ...
  styleUrls: ['./solicitudes-editar.component.css']
})
  ...
  SearchRecord(){
    ...
    this.service.SearchRecord(id).subscribe({
      next:(data: SolicitudModel)=>{
        ...
        this.GetDF["fecha_radicado"].setValue(data.fecha_radicado);
        this.GetDF["nombre_trabajo"].setValue(data.nombre_trabajo);
        this.GetDF["id_tipoSolicitud"].setValue(data.id_tipoSolicitud);
        this.GetDF["id_modalidad"].setValue(data.id_modalidad);
        this.GetDF["id_LineaInvestigacion"].setValue(data.id_LineaInvestigacion);
